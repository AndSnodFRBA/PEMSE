...
DOCS = [
    ...
    dict(slug='cpr-card',         label="AHA HCP CPR card",             hint="American Heart Association Healthcare Provider — front & back",          required=True,  icon_color='#1557a0', icon_bg='#dde9f8', order=2),
