...
urlpatterns = [
    ...
    path('students/<int:pk>/late-fee/add/',    views.add_late_fee,          name='staff_add_late_fee'),
    path('students/<int:pk>/late-fee/<int:fee_id>/waive/', views.waive_late_fee, name='staff_waive_late_fee'),
    ...
    path('instructors/<int:pk>/assignments/<int:assignment_id>/toggle-grade-entry/', views.staff_instructor_toggle_grade_entry, name='staff_instructor_toggle_grade_entry'),
